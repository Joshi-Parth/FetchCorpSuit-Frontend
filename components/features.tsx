      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">Empowering your business with intelligent solutions</h2>
            <p className="text-xl text-gray-400">Your go-to for innovative solutions to everyday corporate challenges!</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Meeting Transcription</h4>
              <p className="text-lg text-gray-400 text-center">Accurate NLP-based transcriptions allow users to query and get answers from their meeting notes instantly</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="100" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Minutes of Meeting (MoM)</h4>
              <p className="text-lg text-gray-400 text-center">Turn a 1-hour meeting into a 30-second actionable MoM, saving time and enhancing team productivity</p>
            </div>
